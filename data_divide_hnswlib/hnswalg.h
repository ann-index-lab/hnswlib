...
namespace data_divide_hnswlib {
    ...
    public:
        ...
        HierarchicalNSW(SpaceInterface<dist_t> *s, size_t max_elements, size_t M = 16, size_t ef_construction = 200, bool compact = false, size_t random_seed = 100) :
